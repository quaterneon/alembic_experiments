...
import schema1_B.tables as s1b_tables
import schema2_B.tables as s2b_tables
import base_B.tables as bb_tables
...
target_metadata = [bb_tables.metadata, s1b_tables.metadata, s2b_tables.metadata]
